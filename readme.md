...
After setting up the repository, head to [getting started](docs/initial_docs/getting-started.md) to get familiar with your new knowledge base!
...
- [getting-started](docs/initial_docs/getting-started.md) - learn how to use your Foam workspace
